...
$ECHO
$ECHO "This example shows how to use DyNaMol.x to calculate the band structure of a s-band honeycomb lattice"
...
&atom
 ...
 r(2,:) =-0.33333333333333,   0.33333333333333, 0.00000000000000 
 /
&mesh
 type = 'mp'
 gx = 50, 50, 1
